(function ($) {
  ...
  // let counter = 0;
  // $('.tab ul.tabs').addClass('active').find('> li:eq(0)').addClass('current');
  // $('.tab div.tab_content div.tabs_item form div.row div.col-lg-6 div.row div.col-12 button').on('click', function (g) {
  // 	counter++;
  // 	console.log(counter);
  // 	var tab = $(this).closest('.tab'),
  // 	index = $(this).closest('li').index();
  ...
  // 	$(this).closest('li').addClass('current');
  // 	console.log(index);
  // 	tab.find('.tab_content').find('div.tabs_item').not('div.tabs_item:eq(' + counter + ')').slideUp();
  // 	tab.find('.tab_content').find('div.tabs_item:eq(' + counter + ')').slideDown();
  // 	g.preventDefault();
  //  });
